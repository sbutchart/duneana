...
dune::GenRecoValidator::GenRecoValidator(fhicl::ParameterSet const& p)
  ...
  fSaveIonAndScintInfo(p.get<bool>("SaveIonAndScintInfo", true)),
  fSaveGenieGenInfo(p.get<bool>("SaveGenieGenInfo", true)),
  fSaveHitsInfo(p.get<bool>("SaveHitsInfo", true)),
  fSavePhotonsInfo(p.get<bool>("SavePhotonsInfo", true))

...
namespace solar
{
    ...
    public:
        ...
        void ComputeDistance3D(double dist, double t1, double y1, double z1, double t2, double y2, double z2);
        void ComputeDistanceX(double dist, double t1, double t2);
    ...
    private:
        ...
        const float fDetectorSizeX;
        const float fDetectorDriftTime;
    };

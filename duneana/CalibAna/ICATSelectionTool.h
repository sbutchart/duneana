#ifndef DUNEANA_ICATSelectionTool
#define DUNEANA_ICATSelectionTool
...
class ICATSelectionTool {
public:
  ICATSelectionTool(const fhicl::ParameterSet &p):
  ...
  virtual ~ICATSelectionTool() noexcept = default;
